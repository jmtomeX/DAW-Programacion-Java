...
public class BBDD {
   ...
   /*
   Crea el método insertarSistemas dentro de la clase BBDD. No recibe ningún parámetro y trata de insertar el departamento Sistemas con el código 7 en la BBDD.
   Devuelve true si la operación se ejecuta correctamente, false en caso contrario.
