...
1. Tendrá un atributo más de tipo entero denominado size. Se deberá inicializar en el constructor
   a partir del valor indicado como parámetro.
2. El método trinar mostrará por consola el siguiente texto: "Piopio - Piopio"
3. Tendrá el método tipoCanario. No necesita parámetros y devolverá un String indicando el tipo de
   canario:
