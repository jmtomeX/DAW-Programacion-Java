...
public class EjemploMenus implements ActionListener {
   ...
   public static void main(String[] args) throws FileNotFoundException {
      ...
      EjemploMenus gui = new EjemploMenus(miBanco);
   }
   ...
   // Constructor
   public EjemploMenus(Banco unBanco) {
   ...
   public void actionPerformed(ActionEvent evento) {
      ...
      if (textoOpcion.equals("Opción 2")) {
         DialogoVerificador unDialogo = new DialogoVerificador(esteBanco, areaTexto);
         return;
      }
   }
}