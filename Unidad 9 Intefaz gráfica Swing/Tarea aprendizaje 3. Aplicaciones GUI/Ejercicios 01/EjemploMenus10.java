...
public class EjemploMenus10 implements ActionListener {
   ...
   public static void main(String[] args) throws FileNotFoundException {
      ...
      EjemploMenus10 gui = new EjemploMenus10(miBanco);
   }
   ...
   // Constructor
   public EjemploMenus10(Banco unBanco) {
   ...
   private JMenuBar crearMenuBar() {
      ...
      String[] opciones = {"Opción 1 Cuenta con menor saldo", "Opción 2 del submenú"};
   ...
   public void actionPerformed(ActionEvent evento) {
      ...
      String texto = "";
      if(!textoOpcion.equals("Opción 1 Cuenta con menor saldo")){
         texto = "Se ha elegido la opcion: " + textoOpcion;
      ...
      if(textoOpcion.equals("Opción 1 Cuenta con menor saldo")) {
         texto =  "La cuenta con menor saldo es: " + esteBanco.saldoMenor();
