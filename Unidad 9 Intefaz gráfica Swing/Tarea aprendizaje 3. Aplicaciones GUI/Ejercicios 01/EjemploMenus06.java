...
public class EjemploMenus06 implements ActionListener {

   // Se puede incluir el main en la clase
   public static void main(String[] args) {
      EjemploMenus06 gui = new EjemploMenus06();
   }
     ...
     // Añadimos un separador
      ...
      try {
         ...
         while (leerFichero.hasNext()) {
            ...
            JMenu subMenu2 = new JMenu(opcion);
            JMenuItem opcionMenu = new JMenuItem(opcion);
         ...
         //Creamos el submenu de los blancos   
         JMenu MenuTonosBlancos = new JMenu("Blanco");
         String[] tonoBlanco = {"Puro", "Hueso"};
         for (int i = 0; i < tonoBlanco.length; i++) {
            String blancos = tonoBlanco[i];
            JMenuItem tono = new JMenuItem(blancos);
            tono.addActionListener(this);
            MenuTonosBlancos.add(tono);
               
         }
         menu2.add(MenuTonosBlancos);
