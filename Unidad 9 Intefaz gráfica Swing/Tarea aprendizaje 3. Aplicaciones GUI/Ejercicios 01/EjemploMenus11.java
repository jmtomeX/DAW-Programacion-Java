...
public class EjemploMenus11 implements ActionListener {
   ...
   public static void main(String[] args) throws FileNotFoundException {
      ...
      EjemploMenus11 gui = new EjemploMenus11(miBanco);
   }
   ...
   // Constructor
   public EjemploMenus11(Banco unBanco) {
   ...
   public void actionPerformed(ActionEvent evento) {
      ...
      if (textoOpcion.equals("Opción 1")) {
         Dialogo11 unDialogo = new Dialogo11(esteBanco);
         return;
      }
   }
}