...
Ten en cuenta que:
    ...
    La ventana principal tendrá un tamaño de 400 x 150, utiliza BorderLayout y  cuando se cierra el
    programa acaba.
    Se crea un JPanel con FlowLayout para organizar las etiquetas, la caja de texto y el JComboBox 
    en la zona centro.
...
public class CirculoGUI10 {

   // Programa principal
   public static void main(String[] args) {
      String[] colores = {"Blanco", "Negro", "azul", "Verde"}; 
      CirculoGUI10 gui = new CirculoGUI10(colores);
   }
   ...
   // Constructor
   public CirculoGUI10(String[] colores) {
      ...
      // Crea y configura la etiqueta y la caja de texto para el radio.
