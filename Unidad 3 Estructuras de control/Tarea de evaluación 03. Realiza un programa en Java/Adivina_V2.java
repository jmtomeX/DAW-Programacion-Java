...
import java.util.*;
public class Adivina_V2 {
   public static final int INTENTOS_MAX = 1000000;
   public static int partidasJugadas = 0;
   public static int mejorPartida = 0;
   public static void main(String[] args) {
      Scanner teclado = new Scanner(System.in);
      int totalIntentosJugando = 0;
      introduccion();
      int intentosPartida = jugarPartida (teclado, totalIntentosJugando);
      mostrarEstadisticas(intentosPartida);
   }
