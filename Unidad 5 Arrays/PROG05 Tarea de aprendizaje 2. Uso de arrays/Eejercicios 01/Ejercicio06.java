...
Los datos están guardados en un arrays. El 1 indica que el alumno o alumna hará 
el examen en "Araba", el 2 que lo hará en "Bizkaia" y el 3 que lo hará en "Gipuzkoa".
*/
import java.util.*;
